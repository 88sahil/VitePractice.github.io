  ...
  return (
   ...
   <header>
      <nav className='flex justify-between w-full shadow-md items-center p-4'>
        <div className='flex'>
          <a className='flex  items-center gap-2 font-extrabold text-[25px]'><img src={Logo} alt="logo" className='w-10 h-10'/>Sahil's<span className='text-orange-600'>Cloths</span></a>
        </div>
